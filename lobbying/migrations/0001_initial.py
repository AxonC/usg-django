# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-12-15 17:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.CharField(max_length=75, verbose_name='donation recipient')),
                ('party', models.CharField(choices=[('R', 'Republican'), ('D', 'Democratic'), ('C-IND', 'Independent (CON)'), ('P-IND', 'Independent (PROG)')], max_length=20, verbose_name='party of Recipiant')),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=0, default=Decimal('0.0'), default_currency=b'USD', max_digits=7, verbose_name='amount Donated')),
                ('notes', models.TextField(verbose_name='donation notes')),
                ('deposited_status', models.BooleanField(default=False, verbose_name='has the donation been deposited?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('organisation', models.CharField(max_length=55, verbose_name='name of Organisation')),
                ('classification', models.CharField(choices=[('CON', 'Conservative'), ('PRO', 'Progressive'), ('NON', 'Non-Partisan')], max_length=25, verbose_name='type of Organisation')),
            ],
        ),
        migrations.AddField(
            model_name='donation',
            name='organisation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lobbying.Organisation'),
        ),
    ]
